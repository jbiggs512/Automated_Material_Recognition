...
class Config:
    ...
    def stages(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            dict(name="layer4", epochs=e1, lr_max=5e-4, wd=0.03,  label_smoothing=0.08, use_class_weights=True),
            dict(name="layer3", epochs=e2, lr_max=2e-4, wd=0.05,  label_smoothing=0.05, use_class_weights=False),
